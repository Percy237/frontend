...
import PieChartCustomizedLabel from "../components/PieChartCustomizedLabel.jsx.jsx";
  ...
  return (
    <div>
      <di className="flex gap-2">
        <TotalCard text="Total Certificates" total="200" />
        <TotalCard text="Total Birth Certificates" total="100" />
        <TotalCard text="Total Death Certificates" total="100" />
      </di>
      ...
      <div className="h-70 w-full mt-4 bg-white shadow-md font-bold rounded-md">
        <div className="h-10 border-b border-b-gray-1 flex justify-between items-center px-3">
          <div className="flex gap-2 items-center">
            ...
            <h1 className="capitalize">Certificates summary</h1>
          </div>
